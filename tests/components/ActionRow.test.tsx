...
describe('<ActionRow/>', () => {
  it("devrait afficher les informations des actions d'un jeune", () => {
    ...
    render(<ActionRow action={action} jeuneId={'1'} borderStyle='' />)
    expect(
  ...
  it("devrait afficher un badge 'Commencée' quand l'action a été commencée", () => {
    ...
    render(<ActionRow action={actionCommencee} jeuneId={'1'} borderStyle='' />)
  ...
  it("devrait afficher un badge 'Terminée' quand l'action est terminée", () => {
    ...
    render(<ActionRow action={actionTerminee} jeuneId={'1'} borderStyle='' />)
