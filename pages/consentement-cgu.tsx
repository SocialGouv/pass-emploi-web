...
function ConsentementCgu(props: ConsentementCguProps) {
  ...
  const estConseillerBRSA =
    props.conseiller.structure === StructureConseiller.POLE_EMPLOI_BRSA

  function metAJourConsentement() {
    setADonneSonConsentement({ value: !aDonneSonConsentement.value })
  }
  async function valideLesCGU(e: FormEvent<HTMLFormElement>) {
    e.preventDefault()
    if (!aDonneSonConsentement.value)
      setADonneSonConsentement({
        ...aDonneSonConsentement,
        error: `Acceptez les Conditions Générales d’Utilisation`,
      })
    else {
  ...
  return (
    <>
      <header className='flex justify-between items-center flex-col py-8 border-b border-solid border-primary_lighten mb-8'>
        ...
        <h1 className='text-xl-bold text-primary mb-4'>{props.pageHeader}</h1>
      ...
      <div>
        ...
        <p className='my-8'>
          ...
          fixent le cadre juridique de la Plateforme « pass emploi » et
        ...
        <p className='mb-8'>
          Tout Usager qui est en situation de décrochage peut créer un compte
          via l’application « pass emploi » et utiliser l’application pour être
        ...
        <p className='mb-8'>
          ...
          décrochage des jeunes en accompagnement vers l’emploi. En ce sens,
          elle cherche à améliorer la mise en relation des jeunes et leur
          conseiller ou conseillère, force de proposition d’actions et conseils
          aux jeunes.
        </p>
        ...
        <p className='mb-8'>
          ...
          <br />
          « L’Usager » est tout jeune en situation de « décrochage », s’étant
          créé un compte, accompagné dans sa recherche par un Conseiller,
          souhaitant trouver des ressources ou être accompagné dans son projet
          professionnel en général. Cette situation de décrochage peut notamment
          s’exprimer par des difficultés dans la recherche d’emploi ou de
          formation, dans le suivi, ou le manque de connaissances et de
        ...
        <p className='mb-8'>
          ...
          utiliser la plateforme dans les conditions prévues. En outre, le
          profil « Superviseur » permet aux agents habilités d’organiser et de
          modifier l’affectation d’un jeune à un Conseiller déterminé.
        </p>
        <p className='mb-8'>A- Conseiller en Mission Locale</p>
        <p className='mb-8'>
          L’authentification se fait via les identifiants de l’outil
          professionnel i-Milo : un identifiant et un mot de passe. Si
          l’utilisateur est déjà authentifié dans son outil i-Milo (également
          une web app), il accède à son portail pass emploi sans écran
        ...
        <ul className='list-disc'>
          <li>
            ...
            l’action, la décrire et en définir le statut (à réaliser, commencée
            ou terminée) ;
          </li>
          <li>
            Visualiser toutes les actions concernant les Usagers qu’il
            accompagne ; Ces actions sont triées selon leur statut ; commenter
            une action et échanger avec ses Usagers sur les actions à réaliser.
          </li>
        </ul>
        ...
        <p className='mb-8'>
          Les Conseillers peuvent prendre des rendez-vous avec des « Usagers »
          et en choisir les modalités (nom de l’Usager, date du rendez-vous,
        ...
        <p className='mb-8'>
          Les Conseillers peuvent recevoir des notifications dès lors qu’un
          Usager a interagi avec eux, notamment pour annuler ou confirmer un
          rendez-vous, ou lorsqu’ils reçoivent un message via le chat.
        </p>
        ...
        <p className='mb-8'>
          ...
          Néanmoins, s’il était suivi par un agent Pôle Emploi, ses actions et
          ses rendez-vous seront conservées dans l’outil Pôle Emploi.
        </p>
        <p className='mb-8'>B – Suppression par le Conseiller</p>
        <p className='mb-8'>
          Les Conseillers peuvent également supprimer le compte d’un usager
          qu’il suit en cliquant sur le bouton « Supprimer ». Cette suppression
          ne peut survenir que pour 3 motifs :
        </p>
        <ul className='list-disc'>
        ...
        <p className='mb-8'>
          ...
          compte et des modalités pour avoir accès à ses informations et données
          à caractère personnel relatives à l’application. Pour ce faire chaque
        ...
        <p className='mb-8'>
          ...
          légales ou pour n’importe quelle raison jugée opportune par l’équipe
          de la plateforme, et ce, sans préavis.
        </p>
        ...
        <ul className='list-disc'>
          ...
          <li>
            ...
            dispositions légales et réglementaires en vigueur, en particulier à
            ne pas publier de message racistes, sexistes, injurieux, insultants
        ...
        <p className='mb-8'>
          Toute information transmise par l’Usager est de sa seule
          responsabilité. Il est rappelé que toute personne procédant à une
          fausse déclaration pour elle-même ou pour autrui s’expose, notamment,
          aux sanctions prévues à l’article 441-1 du code pénal, prévoyant des
          peines pouvant aller jusqu’à trois ans d’emprisonnement et 45 000
        ...
        <p className='mb-8'>
          ...
          particulier, l’Utilisateur s’engage à ne pas publier dans le champ
          libre de question, de message racistes, sexistes, injurieux,
          insultants ou contraires à l’ordre public.
        </p>
        <p className='mb-8'>
          Toute question ou propos peut être supprimé s’il contrevient à une
          disposition des présentes CGU, s’il est contraire à des dispositions
      ...
      <form onSubmit={valideLesCGU}>
        <div className='mb-10'>
          ...
          <Checkbox
            ...
            onChange={metAJourConsentement}
          />
        </div>
        <Button type='submit' className='w-[100px] mx-auto'>
          Valider
        </Button>
      </form>
    </>
